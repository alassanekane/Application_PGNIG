            ...
            echo '<div class="accordion-group">'
              ...
              .'<div id="collapse-'.$nb_donnees['id_utilisateur'].'" class="accordion-body collapse" style="height: 0px; ">'
                ...
                .'<table class="table table-striped table-bordered table-condensed">'
                        ...
                        .'<th><span class="label label-info">Droit d\'utilisateur</span></th>'
                        .'</tr>'
                        .'<tr>'
...
.'<a class="btn btn-warning" href="travel_expensive.php?modifuser='.$nb_donnees['id_utilisateur'].'" id="modifuse"><i class="icon-pencil icon-white"></i>Modifier</a>'
