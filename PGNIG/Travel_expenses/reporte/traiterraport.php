...
<div>
         ...
         <?php 
         if(($_GET['traiterraport']=='success')&&(!empty($_GET['id_report']))&&(!empty($_GET['id_user']))):
...
//                 .'<a class="btn" href="travel_expensive.php?modifexpense&id_report='.$inforeport['id_report'].'&id_expenses='.$array['id_expenses'].'" ><i class="icon-pencil"></i></a>'
                      ...
                      if($array['statue_item']==1){
                        echo ' <a class="btn btn-success" id="valideexpenses_mg" ><i class="icon-ok"></i></a>';
                        echo ' <a class="btn btn-danger" id="effaceexpenses_mg" ><i class="icon-trash"></i></a>';
                        }
      ...
      <div class="control-group">
        ...
        <a class="btn btn-danger" href="travel_expensive.php?travel_encour=1" >Annuler</a>
        </div>
    </div>
    </div>
          <?php 
