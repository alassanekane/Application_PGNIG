...
if ( isset( $_POST['nom'] ) && isset ( $_POST['prenom']) &&  isset ( $_POST['email']) && isset ( $_POST['login'])&& isset ( $_POST['pass'])&&isset($_POST['datenaissance'])&&isset($_POST['pays'])&&isset($_POST['type_user'])){
 ...
 $query=("INSERT INTO `Travel_expensive`.`ComptesUtilisateur` (`id_utilisateur`, `login`, `pass`, `prenom`, `nom`, `email`, `type_utilisateur`, `pays`, `datenaissance`, `numero`) VALUES (NULL, '$login', '$pass', '$prenom', '$nom', '$email', '$type_user', '$pays', '$datenaissance', '$numero')");                       
