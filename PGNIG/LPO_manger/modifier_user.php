...
<!--               <input type="text" data-datepicker="datepicker" class="required date hasDatepicker focusField" id="date1"> -->
          ...
          <div class="controls" id="<?php if($nb_donnees['type_utilisateur']==2){echo $nb_donnees['departement'];}?>">
            ...
            <div class="control-group" id="inser_depart">
          ...
          <div class="form-actions">
            ...
            <a class="btn btn-danger" href="lpo_manager.php" class="travel_expensive.php">Cancel</a>
          </div>
        </fieldset>
      </form>
</div>
...
?>
        <?php header ('Location: lpo_manager.php'); ?>
<?php
endif;
?>